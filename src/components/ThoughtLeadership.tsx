            ...
            <button
              ...
              className={`text-xs font-bold px-4 py-2 rounded-xl transition cursor-pointer font-sans ${
                activeCategory === cat
                  ...
                  : "bg-white hover:bg-slate-100/80 border border-slate-200 text-slate-600"
              }`}
            >
              {cat}
            </button>
              ...
              >
                ...
                <div className="border-t border-slate-100 pt-5 mt-6 flex items-center justify-between text-xs">
                  ...
                  <button
                    ...
                    className="text-[11px] font-mono font-black uppercase text-sky-600 hover:text-sky-800 flex items-center gap-1 group-hover:translate-x-0.5 transition-all cursor-pointer"
                  >
                    Open Full Briefing
