...
const docs: Record<NonNullable<DocPage>, { title: string; content: string[] }> = {
  privacy: {
    ...
    content: [
      ...
      "3. Data Storage & Security: All digital records are secured with industry-standard encryption. Physical notes are stored in locked, access-controlled facilities under the direct custodianship of Christopher Mushwana.",
  ...
  fsp: {
    ...
    content: [
      ...
      `Underwriter: FSCA-licensed insurers`,
      `Key Individual: Christopher Mushwana (MBChB)`,
      ...
      "Complaints Resolution: Complaints may be directed to the FAIS Ombud at https://www.faisombud.co.za or via telephone at 012 762 5000.",
  ...
  conflict: {
    ...
    content: [
      ...
      "6. Governance: This policy is reviewed annually by the Key Individual (Christopher Mushwana). All staff and representatives receive annual conflict of interest training.",
  ...
  complaints: {
    ...
    content: [
      ...
      "6. Escalation: If unsatisfied with the resolution, clients may escalate to the Key Individual, Christopher Mushwana, for final internal review.",
      "7. External Recourse: Clients retain the right to refer unresolved complaints to the FAIS Ombud at https://www.faisombud.co.za or by telephone at 012 762 5000.",
